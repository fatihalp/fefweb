...
Tabs = {
    ...
    GoTo: function (contentId, skipReplace) {
        ...
        for (var i = 0; i < divs.length; i++) {
            ...
            if (div.className.match(/\btabbedcontent\b/i)) {
...
if (document.createStyleSheet) {
    ...
    style.addRule("div.tabbedcontent", "display: none;");
    ...
    if (head) {
        ...
        style.appendChild(document.createTextNode("div.tabbedcontent { display: none; }"));
